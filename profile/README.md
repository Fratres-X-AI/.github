...
**1. Public software** - public repos people can clone  
...
- [JamBoy](https://github.com/Fratres-X-AI/JamBoy) - GPS-denied drone nav: optical flow + offline geo-match + EKF to MAVLink
